...
RSpec.describe Address, :type => :model do
  ...
  context 'validations' do
	  ...
	  it 'longitude must be < 180' do
	  	invalid_address = Address.create(full_address: '25 City Road', lat: 0, lng: 190)
	  	expect(invalid_address).not_to be_valid
